...
class best_grid(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        campos.append(self.criar_campo("Description", QVariant.String, comprimento=255))
        ...
        for i in range(1, 5):
            campos.append(self.criar_campo(f"prof_cam{i}", QVariant.Double, comprimento=20, precisao=2))
            campos.append(self.criar_campo(f"solo_cam{i}", QVariant.String, comprimento=255))
            campos.append(self.criar_campo(f"cor_cam{i}", QVariant.String, comprimento=255))
            campos.append(self.criar_campo(f"vestigios_cam{i}", QVariant.String, comprimento=255))
            campos.append(self.criar_campo(f"quant_vest{i}", QVariant.Int, comprimento=10))
        campos.append(self.criar_campo("observacao", QVariant.String, comprimento=200))
