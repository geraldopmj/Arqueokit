...
class BurndownTemporal(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        return self.tr(
            "Gera um gráfico de Burndown com base em um campo de data, comparando a curva ideal e a curva real.\n\n"
            "Importante: para que o gráfico comece mostrando o total planejado antes do primeiro dia de campo, "
            "defina a Data de início como o dia anterior ao primeiro dia efetivamente trabalhado. "
            "Se você usar exatamente o primeiro dia de campo como início, a curva real já pode começar abatendo "
            "pontos nesse mesmo dia e o gráfico parecer 'adiantado'.\n\n"
            "Parâmetros principais:\n"
            "- Camada: camada de pontos da prospecção.\n"
            "- Atributo de data: campo que registra a data de execução/realização.\n"
            "- Data de início: início da janela do gráfico; normalmente use o dia anterior ao primeiro dia de campo.\n"
            "- Data de término: último dia considerado no acompanhamento.\n"
            "- Título do gráfico: texto exibido no topo do PNG gerado."
        )
